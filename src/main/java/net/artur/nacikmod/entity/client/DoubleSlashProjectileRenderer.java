...
public class DoubleSlashProjectileRenderer extends EntityRenderer<DoubleSlashProjectile> {
    private final DoubleSlashProjectileModel<DoubleSlashProjectile> model;

    public DoubleSlashProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DoubleSlashProjectileModel<>(context.bakeLayer(DoubleSlashProjectileModel.LAYER_LOCATION));
    }

    @Override
    public void render(DoubleSlashProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(DoubleSlashProjectile entity) {
