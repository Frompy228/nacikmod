...
import net.artur.nacikmod.entity.projectiles.TripleSlashProjectile;
...
public class TripleSlashProjectileRenderer extends EntityRenderer<TripleSlashProjectile> {
    private final TripleSlashProjectileModel<TripleSlashProjectile> model;

    public TripleSlashProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new TripleSlashProjectileModel<>(context.bakeLayer(TripleSlashProjectileModel.LAYER_LOCATION));
    }

    @Override
    public void render(TripleSlashProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack,
