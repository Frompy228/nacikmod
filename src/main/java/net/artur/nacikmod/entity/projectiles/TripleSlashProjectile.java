...
public class TripleSlashProjectile extends ThrowableItemProjectile {
    private static final float DAMAGE = 90.0F;
    private int lifetime = 0;
    private static final int MAX_LIFETIME = 60;

    public TripleSlashProjectile(Level level, LivingEntity shooter) {
        super(ModEntities.TRIPLE_SLASH_PROJECTILE.get(), shooter, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.TRIPLE_SLASH.get();
    }
