...
public class SlashProjectile extends ThrowableItemProjectile {
    ...
    public SlashProjectile(Level level, LivingEntity shooter) {
        super(ModEntities.SLASH_PROJECTILE.get(), shooter, level);
        this.setNoGravity(true);
    }

    public SlashProjectile(EntityType<? extends ThrowableItemProjectile> type, Level level) {
        super(type, level);
        this.setNoGravity(true);
    }
