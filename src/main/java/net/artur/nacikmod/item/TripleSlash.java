...
public class TripleSlash extends Item {
    private static final int MANA_COST = 500;
    private static final int COOLDOWN_TICKS = 100;

    public TripleSlash(Properties properties) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            // Создаём снаряд
            TripleSlashProjectile projectile = new TripleSlashProjectile(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        tooltipComponents.add(Component.translatable("item.nacikmod.triple_slash.desc1"));
        tooltipComponents.add(Component.translatable("item.nacikmod.triple_slash.desc2")
